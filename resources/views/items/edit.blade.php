        ...
        <div class="col-12">
            <form method="POST" action="{{ route('update',['id'=>$item->id]) }}" id="myform">
                ...
                <div class="form-group">
                    <label>名前</label>
                    <input type="text" name="name" value="{{ $item->name }}" placeholder="記入例：山田　太郎" class="fomr-control">
                </div>
                <div class="form-group">
                    <label>年齢</label>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input type="radio" name="sex" id="sex-unspecified" value="2" @if($item->sex === 2) checked @endif class="form-check-input">
